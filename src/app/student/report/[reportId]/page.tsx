...
/** §7.3 Student report — the one-page BoardX hand-off: where you stand, how
 * you handled questions, where marks went, and what to practise next.
 * Mascot pose is driven by `trend`. */
