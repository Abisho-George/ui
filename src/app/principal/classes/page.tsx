...
import { classTeacherBySection, sectionComparison } from "@/lib/avai-mock-data";
import { AttentionPill } from "@/components/Status";

/** Principal → Classes overview: one card per section, drilling into the
 * class detail page. Reuses the same section-level numbers as BoardX's
 * "Sections" tab — this is another way into the same data, not a second
 * source of truth. */
export default function ClassesPage() {
  return (
    <>
      <h1 className="page-title">Classes</h1>
      <p className="page-sub">Tap a class to see its students, findings and attention level.</p>
            ...
            <div className="card__body">
              ...
              <div style={{ display: "flex", gap: 18, marginTop: 16 }}>
                ...
                <div>
                  ...
                  <div className="stat__value stat__value--sm">{s.highPriorityFindings}</div>
                </div>
              </div>
